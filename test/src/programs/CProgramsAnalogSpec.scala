...
class CProgramsAnalogSpec
  ...
  describe("RV32ICore C analog programs") {
    ...
    it("fibonacci loop smoke", Validation) {
      runBinaryProgram(
    ...
    it("counted loop early exit", Validation) {
      runBinaryProgram(
    ...
    it("filter prefix sum", Validation) {
      runBinaryProgram(
    ...
    it("selection sort writes min/max", Validation) {
      runBinaryProgram(
    ...
    it("binary search found and missing", Validation) {
      runBinaryProgram(
    ...
    it("signed min max control flow", Validation) {
      runBinaryProgram(
    ...
    it("software multiply via shift-add", Validation) {
      runBinaryProgram(
    ...
    it("division remainder via subtraction", Validation) {
      runBinaryProgram(
